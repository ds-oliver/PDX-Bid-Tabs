...
COMPILED_COLUMNS: List[ColumnDef] = [
    ...
    ColumnDef("location_name_raw", "str", True, "Location text from header.", "header heuristic"),
...
STAR_SCHEMAS: Dict[str, List[ColumnDef]] = {
    "dim_project": [
        ...
        ColumnDef("location_name_raw", "str", True, "Raw location.", "compiled location_name_raw"),
        ColumnDef("location_code", "str", True, "Normalized location code.", "config/location_dictionary.csv"),
    ...
    "dim_pay_item": [
        ColumnDef("pay_item_id", "int", False, "Surrogate key.", "keys.py"),
        ColumnDef("item_code_raw", "str", True, "Raw item code.", "compiled item_code_raw"),
        ColumnDef("item_code_norm", "str", True, "Normalized item code.", "compiled item_code_norm"),
        ColumnDef("section_code_raw", "str", True, "Raw section code.", "compiled section_code_raw"),
        ColumnDef("section_code_norm", "str", True, "Normalized section code.", "compiled section_code_norm"),
        ColumnDef("item_desc_canonical", "str", False, "Canonical item description.", "compiled item_description_clean"),
    ],
    "dim_specification": [
    ...
    "fact_bid_schedule_total": [
        ...
        ColumnDef("bid_schedule_id", "int", False, "Schedule FK.", "dim_bid_schedule"),
        ColumnDef("bidder_id", "int", False, "Bidder FK.", "dim_bidder"),
        ColumnDef("schedule_total", "float", True, "Bidder schedule total.", "compiled schedule_total"),
        ColumnDef("total_row_label", "str", True, "Totals label text.", "compiled totals_row_label"),
    ],
    "fact_award": [
        ColumnDef("project_id", "int", False, "Project FK.", "dim_project"),
        ColumnDef("bid_schedule_id", "int", False, "Schedule FK.", "dim_bid_schedule"),
        ColumnDef("external_selected_bidder_id", "int", True, "Externally provided selected bidder FK.", "optional external source"),
        ColumnDef("external_selected_amount", "float", True, "Externally provided selected amount.", "optional external source"),
        ColumnDef("selection_source_note", "str", True, "External selection source note.", "optional external source"),
    ],
    "fact_project_pay_item_metrics": [
        ...
        ColumnDef("apparent_low_total_derived", "float", True, "Derived lowest contractor schedule total.", "derived from fact_bid_schedule_total"),
        ColumnDef("apparent_low_bidder_id_derived", "int", True, "Derived bidder with lowest contractor schedule total.", "derived from fact_bid_schedule_total"),
        ColumnDef("selection_quality_flag", "str", True, "Quality of derived low-total selection.", "OK|TOTALS_MISMATCH|MISSING_TOTALS|TIE|OTHER"),
    ],
}
